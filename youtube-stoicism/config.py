...
# ============================================================
CHANNEL_NAME       = "Stoicism Mind"   # Tên kênh của bạn
...
BASE_TAGS = [
    "stoicism", "philosophy", "motivation", "mindset", "marcus aurelius",
    "seneca", "epictetus", "quotes", "stoic", "success",
    "wisdom", "discipline", "focus", "life lessons"
]
